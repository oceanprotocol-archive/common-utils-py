...
def integration_test(test):
    ...
    Integration tests should live in the `ocean_utils/test/integration` folder and
    `ocean_utils/<package>/test` folders of individual sub-packages.
    """
...
def e2e_test(test):
    ...
    End-to-end tests should live in the `ocean_utils/test/e2e` and `ocean_utils/examples` folders.
    """
